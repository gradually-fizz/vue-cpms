...
import MachineInfo from '../components/machine/MachineInfo.vue'
import ShowCharts from '../components/machine/ShowCharts.vue'
Vue.use(VueRouter)
...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path:'/showcharts', component: ShowCharts}
    ],
  },
]
